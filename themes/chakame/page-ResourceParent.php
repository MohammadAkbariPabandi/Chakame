...
<section class="container resourceParentContent">
    <div class="resourceParentContent_body" >
        <?php
...
<section class="container resourceParent__childe">
    <h4>پروژه هایی که با این طبقه بندی اجرا شده</h4>
    <div class="row">
        <?php
        ...
        if ($posts) {
            foreach ($posts as $recentPost) {
                ...
                echo '<div class="col-md-6 col-12 horizontalCard">';
                    echo '<div class = "row">';
                        echo '<div class="col-md-5 horizontalCard__image">';
                            if($hero){
                                echo '<img src="' . $hero['url'] . '">';
                            }
                        echo '</div>';
                        echo '<div class="col-md-7 horizontalCard__content">';
